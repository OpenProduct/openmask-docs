...
To develop for OpenMask, install OpenMask in the browser of your choice on your development machine. [Download here](https://chrome.google.com/webstore/detail/openmask/penjlddjkjgpnkllboccdgccekpkcbin).
